...
class TeamMembersTableView: UIView {
    ...
    var devs: [TeamMember] = [
        ...
        .init(name: "Rayanne Andrade", ocupation: "Android/IOS Developer", image: "ray", description: "Engenheira da Computação e Android Developer que decidiu se aventurar no mundo de IOS :)", phoneNumber: "(71) 986675810", email: "ray_dsa@hotmail.com", linkedinURL: "rayandradez")
    ]
